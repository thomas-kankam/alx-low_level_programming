...
OA
OAIn this project, I learned about using arithmetic, logical, relational, and boolean
operators in C. Additionally, I practiced declaring and defining variables of type
OAOA`char`, `int`, and `unsigned int`, using `if` and `if...else` statements, and
OAimplementing `while` loops.

OA## Tasks :page_with_curl:
OA
* **0. Positive anything is better than negative nothing**
OA  * [0-positive_or_negative.c](./0-positive_or_negative.c): C program that prints whether
OAOA  a randomly generated number is positive or negative, followed by a new line:
    * Completion of [this source code](https://github.com/holbertonschool/0x01.c/blob/master/0-positive_or_negative_c).
OA    * Stores a different random number every time the program is run.
